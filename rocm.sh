...
../ppp  https://ppa.pika-os.com/dists/pikauwu/rocm/binary-amd64/Packages http://repo.radeon.com/rocm/apt/5.7.2/dists/jammy/main/binary-amd64/Packages http://repo.radeon.com/rocm/apt/5.7.2/ ./
