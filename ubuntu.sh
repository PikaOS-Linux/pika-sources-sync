...
# publish the repo
ssh ferreo@direct.pika-os.com 'aptly publish repo -batch -skip-contents -force-overwrite -component=,,,, pika-amdgpu pika-external pika-main pika-rocm pika-ubuntu filesystem:pikarepo:'
