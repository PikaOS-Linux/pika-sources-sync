...
# Get Extranal Nvidia pool
echo 'deb [trusted=yes] https://ppa.launchpadcontent.net/graphics-drivers/ppa/ubuntu/ lunar main' | sudo tee /etc/apt/sources.list.d/external.list

PPP32=$(../../ppp https://ppa.pika-os.com/dists/lunar/external/binary-i386/Packages https://ppa.launchpadcontent.net/graphics-drivers/ppa/ubuntu/dists/lunar/main/binary-i386/Packages.xz)
if [ ! -z "$PPP32" ]
then
...
PPP64=$(../../ppp https://ppa.pika-os.com/dists/lunar/external/binary-amd64/Packages https://ppa.launchpadcontent.net/graphics-drivers/ppa/ubuntu/dists/lunar/main/binary-amd64/Packages.xz)
if [ ! -z "$PPP64" ]
then
...
# Return to Extranal Nvidia MIRROR
cd ../
mkdir -p ./output
